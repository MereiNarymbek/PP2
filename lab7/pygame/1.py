...
clock_img = pygame.image.load(r"C:\Users\user\Desktop\python\lab7\pygame\clock.png")
clock_face = pygame.transform.scale(clock_img, (WIDTH, HEIGHT))
hand_right = pygame.image.load(r"C:\Users\user\Desktop\python\lab7\pygame\rightarm.png")
hand_left = pygame.image.load(r"C:\Users\user\Desktop\python\lab7\pygame\leftarm.png")
